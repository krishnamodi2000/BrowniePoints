...
public class CourseServiceTest {
    ...
    @Test
    public void getCoursesForTeacher_whenValidTeacherId_shouldReturnListOfCourses() throws GlobalException {
        // Arrange
        String teacherId = "1";
    ...
    public void getCoursesForTeacher_whenInvalidTeacherId_shouldThrowGlobalException() {
        ...
        // Act & Assert
        assertThrows(GlobalException.class, () -> courseService.getCoursesForTeacher(teacherId));
    }

    @Test
    public void addCourseForTeacher_whenValidTeacherAndCourseRequest_shouldReturnNewCourse() throws GlobalException {
        // Arrange
        String teacherId = "1";
    ...
    public void addCourseForTeacher_whenInvalidTeacherId_shouldThrowGlobalException() {
        ...
        // Act & Assert
        assertThrows(GlobalException.class, () -> courseService.addCourseForTeacher(teacherId, courseRequest));
    }

    @Test(expected = GlobalException.class)
    public void testRemoveCourseForTeacherCourseNotFound() throws GlobalException {
    ...
    @Test
    public void testRemoveCourseForTeacherSuccess() throws GlobalException {
        String teacherId = "teacherId";
        String courseId = "courseId";
    ...
    @Test(expected = GlobalException.class)
    public void testRemoveCoursesForTeacherCoursesNotFound() throws GlobalException {
        String teacherId = "teacherId";
    ...
    @Test
    public void testRemoveCoursesForTeacherSuccess() throws GlobalException {
        String teacherId = "teacherId";
        List<String> courseIds = new ArrayList<>(Arrays.asList("course1", "course2"));
